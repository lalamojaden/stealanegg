...
local SelectedMethod = _G.Jaden_SelectedMethod or "TeleportFly"
...
local function CreateOption(Name, Order)
    ...
    Option.MouseButton1Click:Connect(function()
        ...
        _G.Jaden_SelectedMethod = Name

        if _G.Jaden_ConfigSystem then
            _G.Jaden_ConfigSystem.Save()
        end

        print("[Jaden] Method Teleport Selected: " .. Name)
    end)
...
if _G.Jaden_SelectedMethod == nil then
    _G.Jaden_SelectedMethod = "TeleportFly"
end
...
local InitialSpeed = _G.Jaden_TeleportSpeed or 300
...
SpeedTextBox.FocusLost:Connect(function()
    ...
    if Value then
        ...
        _G.Jaden_TeleportSpeed = Value

        if _G.Jaden_TeleportSystem then
            _G.Jaden_TeleportSystem.SetSpeed(Value)
        end
        ...
        print("[Jaden] Teleport Speed: " .. tostring(Value))
    else
        SpeedTextBox.Text = "300"
        _G.Jaden_TeleportSpeed = 300

        if _G.Jaden_TeleportSystem then
            _G.Jaden_TeleportSystem.SetSpeed(300)
        end
...
if _G.Jaden_TeleportSpeed == nil then
    _G.Jaden_TeleportSpeed = 300
end
...
local function ToggleWalkSpeed()
    ...
    if WalkSpeedEnabled then
        ...
        if _G.Jaden_WalkSpeed then
            _G.Jaden_WalkSpeed.SetValue(WalkSpeedValue)
            _G.Jaden_WalkSpeed.Enable()
        end
    else
        WalkSpeedCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        WalkSpeedStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.Jaden_WalkSpeed then
            _G.Jaden_WalkSpeed.Disable()
        end
    end
end
...
WalkSpeedTextBox.FocusLost:Connect(function()
    ...
    if val then
        ...
        if WalkSpeedEnabled and _G.Jaden_WalkSpeed then
            _G.Jaden_WalkSpeed.SetValue(WalkSpeedValue)
        end
    else
        WalkSpeedTextBox.Text = tostring(WalkSpeedValue)
...
local function ToggleAntiTrap()
    ...
    if AntiTrapEnabled then
        ...
        if _G.Jaden_AntiTrap then
            _G.Jaden_AntiTrap.Enable()
        end
    else
        AntiTrapCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AntiTrapStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.Jaden_AntiTrap then
            _G.Jaden_AntiTrap.Disable()
        end
    end
end
...
GodModeButton.MouseButton1Click:Connect(function()
    if _G.Jaden_GodMode then
        _G.Jaden_GodMode.Enable()
    end
...
FastClickButton.MouseButton1Click:Connect(function()
    if not _G.Jaden_ManualFastClick then
        warn("[Jaden] ManualFastClick feature not loaded")
        ShowNotification("Manual Fast Click Not Loaded")
        return
    end

    if _G.Jaden_ManualFastClick.IsEnabled() then
        _G.Jaden_ManualFastClick.Disable()
        ShowNotification("Manual Fast Click Stop")
    else
        _G.Jaden_ManualFastClick.Enable()
...
task.spawn(function()
    task.wait(0.5)
    if _G.Jaden_ManualFastClick then
        if _G.Jaden_ManualFastClick.IsEnabled() then
...
local function ToggleAntiAFK()
    ...
    if AntiAFKEnabled then
        ...
        if _G.Jaden_AntiAFK then
            _G.Jaden_AntiAFK.Enable()
        end
    else
        AntiAFKCheckButton.BackgroundColor3 = Color3.fromRGB(28, 29, 39)
        AntiAFKStroke.Color = Color3.fromRGB(200, 200, 220)
        if _G.Jaden_AntiAFK then
            _G.Jaden_AntiAFK.Disable()
        end
    end
end
...
task.spawn(function()
    ...
    -- ✅ Sync Dropdown
    if _G.Jaden_SelectedMethod then
        SelectedMethod = _G.Jaden_SelectedMethod
        DropdownBtn.Text = SelectedMethod .. " ▼"
    end

    -- ✅ Sync Speed
    if _G.Jaden_TeleportSpeed then
        SpeedTextBox.Text = tostring(_G.Jaden_TeleportSpeed)
    end

    -- ✅ Sync Anti AFK
    if _G.Jaden_AntiAFK then
        if _G.Jaden_AntiAFK.IsEnabled() then
            AntiAFKEnabled = true
