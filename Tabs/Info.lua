...
-- INFO CONTENT
--==================================================
CreateSectionTitle(InfoPage, "Jaden HUB | Steal An Egg", 1)
...
LinkBtn.Text = "Link : https://discord.gg/xkKTrwCUw3"
...
-- COPY FUNCTION
-- ==================================================
local DISCORD_LINK = "https://discord.gg/xkKTrwCUw3"
...
local function CopyDiscord()
    ...
    if Success then
        ...
        print("[Jaden] Discord Link Copied: " .. DISCORD_LINK)
    else
        CopyBtn.Text = "FAILED!"
        ...
        warn("[Jaden] Failed to copy Discord link")
    end
end
