-- ==================================================
-- JADEN HUB | STEAL AN EGG | Loader
-- ==================================================

local BASE_URL = "https://raw.githubusercontent.com/lalamojaden/stealanegg/main/"

_G.Jaden_EnablePrint = false

local oldPrint = print
print = function(...)
    if _G.Jaden_EnablePrint then
        oldPrint(...)
    end
end

print("🔵 Loading JADEN HUB...")

-- ==================================================
-- CACHE SYSTEM
-- ==================================================
_G.Jaden_Cache = _G.Jaden_Cache or {}

local function GetScript(path)
    local fullPath = BASE_URL .. path
    if _G.Jaden_Cache[fullPath] then
        return _G.Jaden_Cache[fullPath]
    end
    local script = game:HttpGet(fullPath)
    _G.Jaden_Cache[fullPath] = script
    return script
end
...
-- ==================================================
Loading.Update(92)
if _G.Jaden_TabsManager then
    _G.Jaden_TabsManager:SelectTabByName("Info")
end
