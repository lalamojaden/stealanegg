-- ==================================================
-- JADEN HUB - TELEPORT SYSTEM (DUAL MODE + DUAL OPTION)
-- ==================================================
...
if not CollectEvent then
    warn("[JADEN] CollectEvent not found")
    return
end

print("[JADEN] TeleportSystem: CollectEvent OK")
...
local function DisableRagdollBypass()
    ...
    print("[JADEN] Ragdoll Bypass: OFF")
end
...
local function TeleportToTarget(TargetPos, Callback)
    if CurrentMethod == "InstantTeleport" then
        print("[JADEN] Instant TP to Target")
        InstantFlyTP(TargetPos, Callback)
    else
        print("[JADEN] FlyTP to Target (Shot TP)")
...
local function FireForestStrike()
    ...
    print("[JADEN] ForestStrike Fired")
end
...
local function AutoStop()
    ...
    print("[JADEN] TeleportSystem: Auto Stop")
end
...
local function FlyToSafeZone()
    ...
    print("[JADEN] FlyTP to Safe Zone")
...
local function StartProcess()
    ...
    print("[JADEN] FlyTP to First Egg (Shot TP)")
...
local function FullReset()
    ...
    print("[JADEN] TeleportSystem: Full Reset")
end
...
local function Enable()
    ...
    if not CollectEvent then warn("[JADEN] CollectEvent not found") return end
    if not TARGET_UID then warn("[JADEN] No Target ID") return end

    FullReset()
    StartProcess()

    print("[JADEN] TeleportSystem: ON | Method: " .. CurrentMethod)
end

local function Disable()
    FullReset()
    print("[JADEN] TeleportSystem: OFF")
end

local function SetTargetId(Id)
    TARGET_UID = Id
    print("[JADEN] TeleportSystem Target ID: " .. tostring(Id))
end
...
local function SetSpeed(Value)
    ...
    FLY_SPEED = Value
    RETURN_SPEED = Value
    print("[JADEN] TeleportSystem Speed: " .. tostring(Value))
end
...
local function SetMethod(Method)
    ...
    print("[JADEN] TeleportSystem Method: " .. CurrentMethod)
end
...
print("✅ JADEN TeleportSystem Loaded (Dual Mode + Dual Option + Register)")
