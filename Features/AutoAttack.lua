-- ==================================================
-- Jaden HUB | FEATURE | Auto Attack (Integrated & Cleaned)
-- ==================================================
...
local function DisableAutoEquip()
    ...
    print("[Jaden] Auto Equip Bat: OFF")
end
...
local function EnableAutoHit()
    ...
    print("[Jaden] Auto Fire Remote: ON")
end
...
local function DisableAutoHit()
    ...
    print("[Jaden] Auto Fire Remote: OFF")
end
...
print("✅ AutoAttack Feature Loaded & Synced with Jaden Hub")
