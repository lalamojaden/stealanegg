...
local function RunGodMode()
    ...
    if not OldHumanoid then
        warn("[Jaden] Humanoid not found")
        return
    end

    print("========================================")
    print("[Jaden] START HUMANOID REPLACE")
    print("========================================")
    ...
    if not NewHumanoid then
        warn("[Jaden] Failed to clone Humanoid")
        return
    end
    ...
    if not NewHumanoid.Parent then
        warn("[Jaden] New Humanoid was removed")
        return
    end

    print("[Jaden] New Humanoid:", NewHumanoid)
    ...
    print("[Jaden] Animator:", Animator)

    -- RESTART ANIMATE
    local Animate = Character:FindFirstChild("Animate")
    if Animate then
        print("[Jaden] Restarting Animate...")
        pcall(function()
    ...
    print("========================================")
    print("[Jaden] HUMANOID REPLACE + ANTI DEATH COMPLETE")
    print("========================================")
end
