-- ==================================================
-- JADEN HUB | FEATURE | Manual Fast Click
-- ==================================================
...
local function EnableManualFastClick()
    ...
    print("[JADEN HUB] Manual Fast Click: ON")
end
...
local function DisableManualFastClick()
    ...
    print("[JADEN HUB] Manual Fast Click: OFF")
end
...
print("✅ JADEN HUB: ManualFastClick Feature Loaded")
